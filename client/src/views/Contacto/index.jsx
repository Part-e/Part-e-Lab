...
const Contacto = () => {
    ...
    const wa = '/src/assets/images/whatsapp.svg';
    const ig = '/src/assets/images/instagram.svg';
    const fb = '/src/assets/images/facebook.svg';
    const email = '/src/assets/images/email.svg';
